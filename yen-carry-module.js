(function () {
  const indicators = [
    { id: "yenCarryReversalProb", name: "日元套息反转概率", value: 55, unit: "%", asOf: "2026-07-24", source: "USD/JPY / JGB / GPIF / 寿险 / SOFR综合评分", rule: { mode: "higherRisk", green: 35, yellow: 55, amber: 70 } },
    { id: "usdJpy", name: "USD/JPY", value: 163.79, unit: "", asOf: "2026-07-24", source: "Bloomberg Línea", rule: { mode: "rangeRisk", lowAmber: 148, lowRed: 140, highAmber: 160, highRed: 170 } },
    { id: "usdJpyReversalSpeed", name: "USD/JPY反转速度", value: 18, unit: "分", asOf: "2026-07-24", source: "163.99高点后回落幅度与速度监控", rule: { mode: "higherRisk", green: 35, yellow: 55, amber: 75 } },
    { id: "jgb10y", name: "10Y日债收益率", value: 2.77, unit: "%", asOf: "2026-07-23", source: "Japan Bond Trading", rule: { mode: "higherRisk", green: 2.4, yellow: 3.0, amber: 3.5 } },
    { id: "jgbCurveStress", name: "日债曲线压力", value: 70, unit: "分", asOf: "2026-07-23", source: "10Y、20Y、30Y JGB综合评分", rule: { mode: "higherRisk", green: 45, yellow: 65, amber: 80 } },
