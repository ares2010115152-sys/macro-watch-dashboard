(function () {
  const indicators = [
    { id: "yenCarryReversalProb", name: "日元套息反转概率", value: 58, unit: "%", asOf: "2026-07-13", source: "USD/JPY / JGB / GPIF / 寿险 / SOFR综合评分", rule: { mode: "higherRisk", green: 35, yellow: 55, amber: 70 } },
    { id: "usdJpy", name: "USD/JPY", value: 162.8, unit: "", asOf: "2026-07-13", source: "LSEG / 用户材料", rule: { mode: "rangeRisk", lowAmber: 148, lowRed: 140, highAmber: 160, highRed: 170 } },
    { id: "usdJpyReversalSpeed", name: "USD/JPY反转速度", value: 38, unit: "分", asOf: "2026-07-13", source: "162.83高点后回落监控", rule: { mode: "higherRisk", green: 35, yellow: 55, amber: 75 } },
    { id: "jgb10y", name: "10Y日债收益率", value: 2.88, unit: "%", asOf: "2026-07-13", source: "用户材料 / JGB", rule: { mode: "higherRisk", green: 2.4, yellow: 3.0, amber: 3.5 } },
    { id: "jgbCurveStress", name: "日债曲线压力", value: 72, unit: "分", asOf: "2026-07-13", source: "10Y、15Y、30Y JGB综合评分", rule: { mode: "higherRisk", green: 45, yellow: 65, amber: 80 } },
    { id: "jgbAuctionDemandStress", name: "日债拍卖需求压力", value: 54, unit: "分", asOf: "2026-07-13", source: "bid-to-cover、尾部利差、长债承接力手工评分", rule: { mode: "higherRisk", green: 45, yellow: 65, amber: 80 } },
    ...
    { id: "foreignUstCustody", name: "外国官方托管美债", value: 2.64, unit: "万亿美元", asOf: "2026-06-24", source: "Federal Reserve H.4.1", rule: { mode: "lowerRisk", green: 3.0, yellow: 2.75, amber: 2.55 } },
    { id: "bojPolicyRate", name: "BOJ政策利率", value: 1.0, unit: "%", asOf: "2026-07-13", source: "BOJ", rule: { mode: "higherRisk", green: 0.75, yellow: 1.25, amber: 1.5 } },
    { id: "bojActiveHikeWindow", name: "BOJ主动触发窗口", value: 42, unit: "分", asOf: "2026-07-13", source: "7/31 BOJ会议 / 2026Q4政策窗", rule: { mode: "higherRisk", green: 35, yellow: 55, amber: 75 } },
