(function () {
  const indicators = [
    { id: "yenCarryReversalProb", name: "日元套息反转概率", value: 52, unit: "%", asOf: "2026-08-14", source: "USD/JPY / JGB / GPIF / 寿险 / SOFR综合评分", rule: { mode: "higherRisk", green: 35, yellow: 55, amber: 70 } },
    { id: "usdJpy", name: "USD/JPY", value: 158.95, unit: "", asOf: "2026-08-14", source: "外汇市场收盘区间", rule: { mode: "rangeRisk", lowAmber: 148, lowRed: 140, highAmber: 160, highRed: 170 } },
    { id: "usdJpyReversalSpeed", name: "USD/JPY反转速度", value: 34, unit: "分", asOf: "2026-08-14", source: "近5日高点后回落幅度与速度监控", rule: { mode: "higherRisk", green: 35, yellow: 55, amber: 75 } },
    { id: "jgb10y", name: "10Y日债收益率", value: 2.865, unit: "%", asOf: "2026-08-13", source: "Japan Bond Trading", rule: { mode: "higherRisk", green: 2.4, yellow: 3.0, amber: 3.5 } },
    { id: "jgbCurveStress", name: "日债曲线压力", value: 75, unit: "分", asOf: "2026-08-13", source: "10Y、20Y、30Y JGB综合评分", rule: { mode: "higherRisk", green: 45, yellow: 65, amber: 80 } },
    ...
    { id: "foreignUstCustody", name: "外国官方托管美债", value: 2.596842, unit: "万亿美元", asOf: "2026-08-12", source: "Federal Reserve H.4.1", rule: { mode: "lowerRisk", green: 3.0, yellow: 2.75, amber: 2.55 } },
    { id: "bojPolicyRate", name: "BOJ政策利率", value: 1.0, unit: "%", asOf: "2026-07-31", source: "日本银行", rule: { mode: "higherRisk", green: 0.75, yellow: 1.25, amber: 1.5 } },
    { id: "bojActiveHikeWindow", name: "BOJ主动触发窗口", value: 56, unit: "分", asOf: "2026-07-31", source: "7/30-31 BOJ会议 / 2026Q4政策窗", rule: { mode: "higherRisk", green: 35, yellow: 55, amber: 75 } },
