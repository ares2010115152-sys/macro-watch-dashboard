...
const defaultIndicators = [
  {
    ...
    value: 96.00,
    asOf: "2026-06-02",
    source: "Xinhua / ICE Brent settlement",
    frequency: "每日",
    summary: true,
  ...
  },
  {
    ...
    value: 93.76,
    asOf: "2026-06-02",
    source: "Xinhua / NYMEX WTI settlement",
    frequency: "每日",
  ...
  },
  {
    ...
    value: 99.23,
    asOf: "2026-06-03",
    source: "TradersUnion / ICE DXY live口径",
    frequency: "每日",
  ...
  },
  {
    ...
    value: 5158.7,
    asOf: "2026-06-03",
    source: "LiveCharts COMEX Gold futures",
    frequency: "每日",
  ...
  },
  {
    ...
    value: 53.74,
    asOf: "2026-06-03",
    source: "Gold futures / Brent settlement计算",
    frequency: "每日",
  ...
  },
  {
    ...
    value: 3.62,
    asOf: "2026-06-09",
    source: "Federal Reserve H.15 / SOFR近似口径",
    frequency: "每日",
  ...
  },
  {
    ...
    value: 2.8,
    asOf: "2026-06-11",
    source: "WSJ / Tradeweb / MarketWatch",
    frequency: "每日",
  ...
  },
  {
    ...
    value: 4,
    asOf: "2026-06-11",
    source: "BOJ 6/15-16会议 / FOMC 6/17窗口",
    frequency: "事件",
    thesis: "政策窗口越近，日元融资成本重估和美元流动性季末扰动越容易共振。",
    rule: { mode: "lowerRisk", green: 30, yellow: 14, amber: 7 },
  },
  {
  ...
  },
  {
    ...
    value: 76,
    asOf: "2026-06-11",
    source: "JGB收益率 / BOJ窗口 / 美元流动性综合评分",
    frequency: "每日",
    thesis: "综合JGB收益率、政策窗口、SOFR/RRP/准备金和风险资产拥挤度；高于70说明导火索已经冒烟。",
...
const seedRecords = [
  ...
  ["bojFomcWindow", "2026-06-11", 4, "BOJ 6/15-16与FOMC 6/17窗口临近"],
...
const events = [
  ...
  },
  {
    cadence: "每日",
    title: "日元套息与JGB压力",
    body: "跟踪10Y JGB、USD/JPY、BOJ政策窗口、日元融资成本和风险资产是否同步去杠杆。",
  },
  {
    cadence: "每周",
...
const bubbleStages = [
  ...
  },
  {
    ...
    body: "JGB收益率上行、BOJ/FOMC政策窗口临近、日元融资成本重估，会让借日元买高Beta资产的链条开始降杠杆。",
    ids: ["jgb10y", "bojFomcWindow", "yenCarryStress", "foreignUstCustody"],
  },
  {
    title: "03 美元流动性：缓冲被抽干",
    body: "QT、TGA上升、ON RRP接近零、准备金下行会削薄缓冲。SOFR、SRF和互换额度变色，意味着美元侧开始冻住。",
    ids: ["tga", "rrp", "bankReserves", "sofrRate", "fundingSpreadProxy", "srfUsage", "swapLineUsage"],
  },
  {
    title: "04 跨市场传染：信用与拥挤仓位反转",
    body: "VIX、MOVE、信用利差和COMEX铜仓位用于确认风险资产是否从估值回调切换为链式平仓。",
    ids: ["vix", "moveIndex", "hySpread", "cloAaaSpread", "privateCreditRedemptions", "copperProducerZ", "copperManagedMoneyPct"],
  },
];
...
const bubbleMonitorRows = [
  ...
  },
  {
    layer: "日元扳机",
    id: "bojFomcWindow",
    threshold: "距离政策窗口<14天转黄；<7天转红",
    logic: "BOJ和FOMC同周会放大政策路径重估，若叠加季末资金紧张，容易触发快速平仓。",
  },
  {
    layer: "日元扳机",
    id: "yenCarryStress",
    threshold: ">60为冒烟；>75为烟花边缘",
    logic: "把JGB、政策窗口、美元流动性和拥挤仓位压成综合分，用来提示套息链条是否正在从冒烟过渡到点火。",
  },
  {
    layer: "美元缓冲",
    id: "rrp",
