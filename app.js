...
const defaultIndicators = [
  ...
  },
  {
    ...
    value: 81,
    asOf: "2026-09-15",
    source: "Japan Bond Trading / 10Y、20Y、30Y JGB综合评分",
    frequency: "每日",
  ...
  },
  {
    ...
    value: 56,
    asOf: "2026-07-31",
    source: "7/30-31 BOJ会议 / 2026Q4政策窗手工评分",
    frequency: "会议",
...
const seedRecords = [
  ...
  ["usdJpy", "2026-07-24", 163.79, "USD/JPY接近52周高点，弱日元供氧仍在，但干预与政策压力继续上升"],
  ["jgb10y", "2026-07-23", 2.77, "10Y JGB维持高位，尚未突破3%的下一档压力线"],
  ["yenCarryReversalProb", "2026-07-24", 55, "汇率仍在高位且未快速反转，日债曲线压力使综合概率维持预热区下沿"],
  ["usdJpyReversalSpeed", "2026-07-24", 18, "USD/JPY仍接近163.99高点，尚无快速升值式平仓确认"],
  ["jgbCurveStress", "2026-07-23", 70, "10Y为2.77%、20Y为3.63%、30Y为3.93%，曲线压力仍高但较极端阈值有距离"],
  ["jgbAuctionDemandStress", "2026-07-02", 45, "10Y拍卖投标约为中标额3.13倍，承接尚未失速"],
  ["bojActiveHikeWindow", "2026-07-24", 48, "7月30-31日BOJ会议临近，政策窗口升温但尚未确认加速"],
  ["brent", "2026-07-24", 99.68, "中东冲突再度升温，布伦特接近100美元"],
  ["wti", "2026-07-23", 86.66, "WTI随地缘供应风险反弹"],
  ["distillate", "2026-07-17", 109.57, "美国馏分油库存升至1.0957亿桶，但仍需结合旺季需求观察"],
  ["usCrudeInv", "2026-07-17", 411.675, "美国商业原油库存增加201万桶至4.11675亿桶"],
  ["spr", "2026-07-17", 311.447, "美国战略石油储备单周下降505.7万桶"],
  ["cpiHeadline", "2026-06-30", 3.5, "美国6月CPI同比回落至3.5%"],
  ["coreCpi", "2026-06-30", 2.6, "美国6月核心CPI同比回落至2.6%"],
  ["gold", "2026-07-24", 4036.60, "现货黄金维持在每盎司4000美元上方"],
  ["goldOilRatio", "2026-07-24", 40.50, "油价反弹压低金油比，防守溢价较6月底收敛"],
  ["ashareTurnover", "2026-07-23", 22100, "沪深两市成交额2.21万亿元，较前一交易日缩量"],
  ["brent", "2026-07-27", 85.87, "美伊暂停互袭后布伦特单日回落6.3%，地缘溢价明显收缩"],
  ["wti", "2026-07-27", 81.90, "停火谈判预期推动WTI回落至82美元附近"],
  ["ust10y", "2026-07-27", 4.65, "10年美债收益率仍处高位，继续约束高估值资产"],
  ["ppiEnergy", "2026-06-30", -6.4, "美国6月PPI最终需求能源分项环比下降6.4%"],
  ["dxy", "2026-07-27", 101.0, "美元指数维持101附近，等待FOMC进一步指引"],
  ["gold", "2026-07-27", 4090.00, "现货黄金在油价回落与避险需求之间维持4000美元上方"],
  ["goldOilRatio", "2026-07-27", 47.63, "油价快速回落推动金油比重新升至高防守区"],
  ["tga", "2026-07-22", 835.417, "TGA较6月高位回落，但仍处偏高水平"],
  ["rrp", "2026-07-22", 0.158, "ON RRP others口径只剩1.58亿美元，缓冲近乎耗尽"],
  ["bankReserves", "2026-07-22", 3.064896, "银行准备金回升至约3.065万亿美元，暂时回到3万亿观察线上方"],
  ["swapLineUsage", "2026-07-22", 0.378, "央行美元互换升至3.78亿美元，仍低但不再是零附近"],
  ["rrpDrawdownPct", "2026-07-22", 99.99, "ON RRP others口径相对峰值几乎完全耗尽"],
  ["rrpVs2019Buffer", "2026-07-22", 0.012, "当前RRP others只相当于2019缓冲的约0.012%"],
  ["reserveDrainPhase", "2026-07-22", 65, "准备金重回3万亿美元上方且TGA回落，综合抽水压力较6月缓和"],
  ["foreignUstCustody", "2026-07-22", 2.623, "外国官方托管美国国债约2.623万亿美元，边际承接仍偏弱"],
  ["vix", "2026-07-27", 18.67, "VIX回到约18.7，尚未触发持续28以上的强制降杠杆条件"],
  ["yenCarryStress", "2026-07-27", 64, "日元仍弱但尚未快速反转，风险主要来自高日债收益率和政策窗口"],
  ["ctaConvexityNeed", "2026-07-27", 58, "VIX低于20且美元资金面未失控，凸性保护需求较6月回落"],
  ["yenCarryReversalProb", "2026-07-28", 57, "USD/JPY约163.86、10年日债逼近2.8%，反转风险小幅升温但尚未确认"],
  ["usdJpyReversalSpeed", "2026-07-28", 16, "USD/JPY仍在高位横盘，尚未出现日元快速升值式平仓"],
  ["jgbCurveStress", "2026-07-28", 72, "10年日债接近2.8%、30年约3.99%，长端财政压力继续升温"],
  ["ashareMarginBalance", "2026-07-13", 2.8891, "融资余额较6月底回落约3.6%，绝对水位仍高但热度边际降温"],
  ["ashareMarginBuyRatio", "2026-07-27", 8.88, "两融交易额占A股成交额降至8.88%，低于此前10%以上危险区"],
  ["ashareTurnover", "2026-07-28", 20300, "沪深两市成交额约2.03万亿元，较上一交易日继续缩量"],
  ["brent", "2026-08-14", 87.91, "布伦特回升至87.91美元，但仍低于7月地缘冲突高点"],
  ["wti", "2026-08-14", 81.72, "WTI报81.72美元，能源风险溢价维持但未重新失控"],
  ["ust10y", "2026-08-13", 4.65, "10年美债收益率维持4.65%高位，折现率约束仍在"],
  ["usCrudeInv", "2026-08-07", 424.410, "EIA：商业原油库存单周增加1742.2万桶"],
  ["distillate", "2026-08-07", 107.149, "EIA：馏分油库存约1.07149亿桶，单周基本持平"],
  ["spr", "2026-08-07", 298.694, "EIA：战略石油储备降至2.98694亿桶，跌破3亿桶"],
  ["cpiHeadline", "2026-07-31", 3.4, "BLS：7月CPI同比回落至3.4%"],
  ["coreCpi", "2026-07-31", 2.5, "BLS：7月核心CPI同比回落至2.5%"],
  ["cpi3mSaar", "2026-07-31", 1.6, "核心CPI近三个月季调环比折年率约1.6%"],
  ["ppiEnergy", "2026-07-31", -3.1, "BLS：7月PPI最终需求能源分项环比下降3.1%"],
  ["gold", "2026-08-14", 4324, "黄金报4324美元，避险价格仍处历史高位"],
  ["goldOilRatio", "2026-08-14", 49.19, "黄金相对布伦特的防守溢价重新升高"],
  ["vix", "2026-08-13", 14.63, "VIX回落至14.63，保护成本偏低"],
  ["tga", "2026-08-12", 959.405, "H.4.1：TGA升至9594亿美元，财政抽水压力重新抬头"],
  ["rrp", "2026-08-12", 0.725, "H.4.1：ON RRP others仅7.25亿美元，缓冲仍近乎耗尽"],
  ["bankReserves", "2026-08-12", 2.947630, "H.4.1：银行准备金降至约2.948万亿美元，再次跌破3万亿观察线"],
  ["swapLineUsage", "2026-08-12", 0.132, "H.4.1：央行美元互换使用量仍接近零"],
  ["foreignUstCustody", "2026-08-12", 2.596842, "H.4.1：外国官方托管美债降至约2.597万亿美元"],
  ["usdJpy", "2026-08-14", 158.95, "USD/JPY从7月164附近回落，但尚未进入140以下强平区"],
  ["jgb10y", "2026-08-13", 2.865, "10年JGB升至2.865%，继续逼近3%压力线"],
  ["usdJpyReversalSpeed", "2026-08-14", 34, "日元从极弱区反弹，套息反转速度上升但尚未确认强平"],
  ["ashareMarginBuyRatio", "2026-08-14", 10.6, "两融交易占比回升至10.6%，重新进入高热度区"],
  ["ashareTurnover", "2026-08-14", 21000, "全A周均成交约2.1万亿元，交投维持活跃"],
  ["brent", "2026-08-25", 87.27, "布伦特在连续上涨后回落3.6%，地缘溢价仍高但边际降温"],
  ["wti", "2026-08-25", 81.43, "WTI回落至81.43美元，缓解部分通胀与长债压力"],
  ["ust10y", "2026-08-25", 4.629, "10年美债收益率回落至约4.63%，仍处高估值资产压力区"],
  ["dxy", "2026-08-25", 98.894, "美元指数跌破99，全球流动性边际改善"],
  ["usCrudeInv", "2026-08-14", 428.815, "EIA：商业原油库存单周增加440.5万桶"],
  ["distillate", "2026-08-14", 105.619, "EIA：馏分油库存单周下降153万桶，仍低于季节均值"],
  ["spr", "2026-08-14", 293.426, "EIA：战略石油储备单周再降526.8万桶"],
  ["gold", "2026-08-25", 4722, "黄金升至4722美元附近，避险与美元走弱共同支撑"],
  ["goldOilRatio", "2026-08-25", 54.11, "金油比升至54以上，市场防守溢价继续扩大"],
  ["vix", "2026-08-25", 15.45, "VIX回落至15.45，尚未确认系统性去杠杆"],
  ["tga", "2026-08-19", 936.406, "H.4.1：TGA仍处9364亿美元高位"],
  ["rrp", "2026-08-19", 0.317, "H.4.1：ON RRP others仅3.17亿美元，缓冲接近耗尽"],
  ["bankReserves", "2026-08-19", 2.930817, "H.4.1：银行准备金降至约2.931万亿美元"],
  ["swapLineUsage", "2026-08-19", 0.123, "H.4.1：央行美元互换仍接近零，跨境美元荒未确认"],
  ["foreignUstCustody", "2026-08-19", 2.586171, "H.4.1：外国官方托管美债继续降至约2.586万亿美元"],
  ["usdJpy", "2026-08-25", 159.21, "USD/JPY维持159附近，弱日元供氧尚未反转但160上方压力仍在"],
  ["jgb10y", "2026-08-25", 2.895, "10年JGB升至约2.90%，逼近3%压力线"],
  ["usdJpyReversalSpeed", "2026-08-25", 31, "日元较7月极弱区反弹，但尚未进入快速强平区"],
  ["brent", "2026-09-15", 108.42, "布伦特升至108美元上方，能源通胀与长债压力重新共振"],
  ["wti", "2026-09-15", 105.57, "WTI单日走高并升破105美元，供应风险溢价显著扩张"],
  ["ust10y", "2026-09-15", 4.996, "10年美债触及5%附近，高估值AI硬件折现率压力明显上升"],
  ["dxy", "2026-09-15", 99.65, "美元指数收于99.65附近，避险与利差支撑增强"],
  ["gold", "2026-09-15", 4332.2, "黄金在高利率与避险需求拉扯下收于4332美元附近"],
  ["goldOilRatio", "2026-09-15", 39.96, "油价急升使金油比由高防守区明显回落"],
  ["vix", "2026-09-15", 17.2, "VIX升至17.2，但仍未确认系统性去杠杆"],
  ["usCrudeInv", "2026-09-04", 424.069, "EIA：商业原油库存单周下降39万桶"],
  ["distillate", "2026-09-04", 106.274, "EIA：馏分油库存单周增加208.6万桶，绝对水位仍偏低"],
  ["spr", "2026-09-04", 285.36, "EIA：战略石油储备单周下降124.4万桶"],
  ["cpiHeadline", "2026-08-31", 3.4, "BLS：8月CPI同比3.4%，环比上涨0.4%"],
  ["coreCpi", "2026-08-31", 2.4, "BLS：8月核心CPI同比2.4%，环比上涨0.3%"],
  ["cpi3mSaar", "2026-08-31", 2.0, "核心CPI近三个月季调环比折年率约2.0%"],
  ["ppiEnergy", "2026-08-31", 4.2, "BLS：8月PPI最终需求能源分项环比上涨4.2%"],
  ["tga", "2026-09-09", 843.705, "H.4.1：TGA回落至8437亿美元，财政抽水较8月缓和"],
  ["rrp", "2026-09-09", 0.432, "H.4.1：ON RRP others仅4.32亿美元，缓冲仍近乎耗尽"],
  ["bankReserves", "2026-09-09", 3.036508, "H.4.1：银行准备金回升至约3.037万亿美元"],
  ["swapLineUsage", "2026-09-09", 0.101, "H.4.1：央行美元互换使用量仍接近零"],
  ["rrpDrawdownPct", "2026-09-09", 99.98, "RRP相对2022年峰值仍已耗尽约99.98%"],
  ["rrpVs2019Buffer", "2026-09-09", 0.033, "当前RRP others只相当于2019缓冲的约0.033%"],
  ["reserveDrainPhase", "2026-09-09", 66, "准备金回到3万亿美元上方且TGA回落，综合抽水压力较8月缓和"],
  ["foreignUstCustody", "2026-09-09", 2.590095, "H.4.1：外国官方托管美债约2.590万亿美元，承接仍偏弱"],
  ["usdJpy", "2026-09-15", 155.13, "USD/JPY回落至155附近，日元反弹但尚未进入140以下强平区"],
  ["jgb10y", "2026-09-15", 3.03, "10年JGB突破3%，日债曲线进入新一档压力区"],
  ["usdJpyReversalSpeed", "2026-09-15", 42, "USD/JPY从前期159附近回落，反转速度升温但未触发强平确认"],
  ["jgbCurveStress", "2026-09-15", 81, "10年JGB突破3%，曲线压力评分进入红灯"],
